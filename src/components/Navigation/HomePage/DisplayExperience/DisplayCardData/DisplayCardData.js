...
class DisplayCardData extends React.Component {
  constructor(props){
    super(props);
    this.state = { 
            expanded: false
  ...
  render() {
    let { classes, userImage, postText } = this.props;
    return (
      <div className="ma4">
        <MuiThemeProvider >
...
DisplayCardData.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(DisplayCardData);